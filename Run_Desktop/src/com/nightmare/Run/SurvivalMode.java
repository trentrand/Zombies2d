...
public class SurvivalMode extends World implements ApplicationListener,
        InputProcessor {
    ...
    public SurvivalMode(int id, GameContainer gc) throws SlickException {
        super(id, gc);
    ...
    public void update(GameContainer gc, StateBasedGame sbg, int delta)
        ...
        if (cs.zombiesSpawned < cs.roundNumber * 25) {
            spawnTimer -= delta;
            while (spawnTimer <= 0) {
                spawnFrame++;
