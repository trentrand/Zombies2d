...
public class MagnumBullet extends Entity {

	public static final String MGBULLET = "mgbullet";
	...
	public MagnumBullet(float x, float y, int angle) {
		super(x, y);
		this.angle = angle;
		centered = true;
		setGraphic(Resources.ss.getSprite(4, 1));
		setHitBox(14, 14, 3, 3);
		this.name = "bullet";
		this.depth = 50;
		addType(MGBULLET, COLLIDABLE);
	}
